        ...
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <div class="text-center mt-5">
              Copyright &copy; Rentbil <script>
                document.write(new Date().getFullYear());
              </script><br>Dibuat oleh Kelompok 8 <a target="_blank" href="https://github.com/stisla/stisla"></a>
              <div class="mt-3">
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('assets/assets_stisla'); ?>/assets/img/unsplash/login-bg.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Rentbil</h1>
                <h5 class="font-weight-normal text-muted-transparent">Tangerang Selatan, Banten, Indonesia</h5>
              </div>
