        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href="javascript:;" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Admin, <?= $_SESSION['nama'] ?></div>
            </a>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('admin/dashboard') ?>"><img src="<?= base_url('assets/assets_stisla') ?>/assets/img/logo.png" height="45" width="45" alt=""> Rentbil</a>
          </div>
