            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-envelope"></i> rentbil@gmail.com
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-2 text-center">
                        <i class="fa fa-whatsapp"></i> 0895331123739
                    </div>
                    <!--== Single HeaderTop End ==-->
                    ...
                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-2 text-center">
                        <i class="fa fa-map-marker"></i> 15226, Kota Tangerang Selatan
                    </div>
                    <!--== Single HeaderTop End ==-->
                        ...
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <?php if (isset($_SESSION['level']) == 2) { ?>
                                    <li><a href="javascript:;"><i class="fa fa-user"></i> User | <?= $_SESSION['nama']; ?></a>
                                        <ul>
